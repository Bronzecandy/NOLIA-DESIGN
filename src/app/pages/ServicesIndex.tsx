  ...
  return (
    <div className={`pt-20 md:pt-24 pb-20 min-h-screen ${shellGutter}`} style={{ backgroundColor: colors.cream }}>
      <div className={shellMax}>
        ...
        <p className={`${tx.bodyTight} mb-12`} style={{ fontFamily: "var(--font-body)", color: colors.green }}>
          {locale === "vi"
        ...
        <div className="mb-14 border p-6 md:p-8" style={{ borderColor: "rgba(82,98,72,0.12)" }}>
          <h2 className={tx.subsectionTitle} style={{ fontFamily: "var(--font-heading)", color: colors.green }}>
            {locale === "vi" ? "Nhà hàng & Bar" : "Restaurant & Bar"}
          </h2>
          <p className={`${tx.body} mb-6`} style={{ fontFamily: "var(--font-body)", color: colors.green }}>
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            {restaurantChildren.map((s) => (
              ...
              >
                ...
                <div className="p-4">
                  <p className={`${tx.cardTitle} group-hover:text-[#AF9666] transition-colors`} style={{ fontFamily: "var(--font-heading)", color: colors.green }}>
                    {s.title[locale]}
                  </p>
                </div>
              </button>
          ...
          {topLevel.map((s) => (
            ...
            >
              ...
              <div className="p-4 flex-1 flex flex-col">
                ...
                <p className={`${tx.cardTitle} flex-1 group-hover:text-[#AF9666] transition-colors`} style={{ fontFamily: "var(--font-heading)", color: colors.green }}>
                  {s.title[locale]}
                </p>
